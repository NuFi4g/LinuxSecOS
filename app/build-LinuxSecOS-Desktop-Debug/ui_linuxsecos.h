...
public:
    ...
    void setupUi(QMainWindow *LinuxSecOS)
    {
        ...
        horizontalLayout_3->addWidget(label_cpu_info);
        ...
        horizontalLayout_5->addWidget(label_ram);

        label_ram_info = new QLabel(gb_hardware);
        label_ram_info->setObjectName(QString::fromUtf8("label_ram_info"));

        horizontalLayout_5->addWidget(label_ram_info);
        ...
        tableView = new QTableView(tab_process);
        ...
        label_pro_alive = new QLabel(tab_process);
        label_pro_alive->setObjectName(QString::fromUtf8("label_pro_alive"));

        horizontalLayout_7->addWidget(label_pro_alive);
    ...
    void retranslateUi(QMainWindow *LinuxSecOS)
    {
        ...
        label_ram_info->setText(QCoreApplication::translate("LinuxSecOS", " []", nullptr));
        ...
        label_pro_alive->setText(QCoreApplication::translate("LinuxSecOS", "\346\264\273\350\277\233\347\250\213\346\225\260  ", nullptr));
